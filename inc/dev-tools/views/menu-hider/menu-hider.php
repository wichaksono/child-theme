...
<style>
    ...
    .menu-column li.menu-item {
        margin-bottom: 1rem;
        padding-bottom: 1rem;
        border-bottom: 1px dashed #e0e0e0;
    }

    .menu-column li.menu-item:last-child {
        border-bottom: none;
        margin-bottom: 0;
        padding-bottom: 0;
    }

    .menu-column .parent-menu .field-label {
        font-weight: 600;
        font-size: 14px;
    }

    .menu-column .submenu-list {
        margin-top: 0.75rem;
        padding-left: 1.5rem;
    }

    .menu-column .menu-item .field-wrapper {
        display: flex;
